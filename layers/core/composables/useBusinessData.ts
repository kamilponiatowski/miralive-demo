...
export const useBusinessData = (): BusinessData => {
  return {
    ...
    longDescription: 'Miralive to nowoczesna agencja ubezpieczeniowa prowadzona przez Mirosławę Poniatowską, specjalizująca się w ubezpieczeniach życiowych i zdrowotnych. Oferujemy indywidualną analizę potrzeb, porównanie ofert od kilkunastu towarzystw ubezpieczeniowych oraz wsparcie na każdym etapie — od wyboru polisy po likwidację szkody. Działamy w województwie kujawsko-pomorskim, łącząc lokalne zaufanie z nowoczesnym podejściem do doradztwa.',
    foundedYear: 2015,
    slogan: 'Twoje bezpieczeństwo, nasza specjalizacja',
    address: {
      street: 'ul. Dworcowa 12',
      postalCode: '85-009',
      city: 'Bydgoszcz',
